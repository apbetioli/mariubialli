...
export default function Footer() {
  ...
  return (
    <footer className="flex flex-col sm:flex-row items-center gap-6 px-6 py-6 sm:py-2 font-medium border-t dark:border-white/20 text-xs text-primary bg-primary-foreground">
