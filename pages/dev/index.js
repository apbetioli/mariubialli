        ...
        <section>
            <Container maxWidth="md">
                <Grid container spacing={2}>
                    ...
                    <Grid item className={classes.centered} xs={12}>
                        <h1 className={classes.title}>Desafio <span className={classes.highlight}>EU VETORIZO!</span></h1>
                        <p className={classes.subtitle}>Aprenda a gerar renda criando seus próprios moldes de feltro.</p>
                        <CTA>
                            Quero ganhar mais
                        </CTA>
                    </Grid>
