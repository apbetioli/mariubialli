...
function html({ url, host, email }: Record<"url" | "host" | "email", string>) {
  ...
  <div style="font-family: Arial, Verdana, sans-serif;">
    <div style="max-width: 500px; margin: auto; background-color: #f9f9f9; padding: 20px;">
      ...
      <a href="${url}" target="_blank" rel="noopener" style="background-color: #016f57; color: white; padding: 10px; border-radius: 5px; text-decoration: none; text-transform: uppercase; font-weight: bold; display: block; margin: 30px auto; width:80%; text-align: center;">Clique aqui para confirmar seu email</a>
